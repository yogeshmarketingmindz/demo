...
var td_wp_admin_demos = {
    ...
    _install_full_td_revolution:function (demo_id) {
                /* ---------------------------------------------------------------------------------------
                 td_media_6
                 */
                td_wp_progress_bar.timer_change(98);
                ...
                jQuery.ajax({
                    ...
                    error: function(MLHttpRequest, textStatus, errorThrown){
                        td_wp_admin_demos._ui_install_end(demo_id);
                        //td_wp_admin_demos._show_network_error('full_demo_revolution', MLHttpRequest, textStatus, errorThrown);
                    }
                });
            },
    ...
    _install_full_td_import:function (demo_id) {
        ...
        /* ---------------------------------------------------------------------------------------
         td_import
         */
        td_wp_progress_bar.timer_change(90);
        var request_data = {
            action: 'td_ajax_demo_install',
        ...
        jQuery.ajax({
            ...
            success: function(data, textStatus, XMLHttpRequest){
                //tdAjaxBlockProcessResponse(data, td_user_action);
//                td_wp_admin_demos._ui_install_end(demo_id);
                td_wp_admin_demos._install_full_td_revolution(demo_id);
            },
            error: function(MLHttpRequest, textStatus, errorThrown){
	...
	_install_full_td_media_portfolio:function (demo_id) {
            /* ---------------------------------------------------------------------------------------
             td_media_6
             */
            td_wp_progress_bar.timer_change(85);
            var request_data = {
                action: 'td_ajax_demo_install',
                td_demo_action:'td_media_portfolio',
                td_demo_id: demo_id
            };
            jQuery.ajax({
                type: 'POST',
                ...
                error: function(MLHttpRequest, textStatus, errorThrown){
                    td_wp_admin_demos._show_network_error('full_demo_media_portfolio', MLHttpRequest, textStatus, errorThrown);
                }
            });
        },
    _install_full_td_media_6:function (demo_id) {
        ...
        jQuery.ajax({
            ...
            dataType: 'json',
            success: function(data, textStatus, XMLHttpRequest){
                td_wp_admin_demos._install_full_td_media_portfolio(demo_id);
            },
            error: function(MLHttpRequest, textStatus, errorThrown){
