...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
  ...
  if (!isset($value['id']))
    ...
    if (  $value['url'] != '' ): // Edited by Thames: add no image
	    echo "<span class='simplePanelImagePreview'><img style='max-width:100%;' {$PreviewStyle} src='{$value['url']}'><br/></span>";
    else : 
        echo "<span class='simplePanelImagePreview'><img style='max-width:100%;' src='". NORENCORE_IMG_URL . "noimage/no_image_150x150.jpg'><br/></span>";
    endif;
