<?php
//Create cookies for utm source data.
...
<div id='crmWebToEntityForm' style='width:600px;margin:auto;'>
  ...
  <!--  <form action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads1034225000008473049 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory()' accept-charset='UTF-8'> -->
	...
	<div class="main-table">
	        ...
	        ?>
		<div class="Learn-div"><a href="tel:888-760-7188"><h4>Contact Our Specialists Now</h4></a></div>
			...
			<div class="chech_box_div">
				...
				<div class="check_panel center_bx"><input type='checkbox' id="ch3"  name='LEADCF109' checked /><span class="check_pan_left">Phone Hardware</span>
				</div>
			...
			<div class="Learn-div"><input type='submit' value='Send' /></div>
	</div>
...
<?php } add_shortcode( 'Zoho_leed', 'zohoform' ); ?>